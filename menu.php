<div class="flex-shrink-0 p-3 col-2" style="background-color: rgb(49, 49, 156);">
    <a href="/"
        ...
        <span class="fs-5 fw-bold text-white">Marketplace - LIS</span>
    </a>
    <ul class="list-unstyled ps-0">
        ...
        <li class="mb-1">
            <button class="btn btn-toggle form-control align-items-center rounded collapsed text-white"
                style="background-color: rgb(49, 49, 156);" data-bs-toggle="collapse"
        ...
        <li class="mb-1">
            <button style="background-color: rgb(49, 49, 156);"
                class="btn btn-toggle form-control align-self-strart rounded collapsed text-white"
